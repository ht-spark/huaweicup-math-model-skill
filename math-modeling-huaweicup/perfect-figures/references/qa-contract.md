...
python perfect-figures/scripts/validate_figure.py path/to/figure.R

# Machine-readable report or stricter warning gate
python perfect-figures/scripts/validate_figure.py path/to/figure.py --json
python perfect-figures/scripts/validate_figure.py path/to/figure.py --strict

# Exported-PDF glyph-size audit
python perfect-figures/scripts/audit_pdf_text.py path/to/figure.pdf --min-pt 5
python perfect-figures/scripts/audit_pdf_text.py path/to/figure.pdf --min-pt 5 --json

# Backend-neutral audit of the render-time Python/R panel-layout manifest
python perfect-figures/scripts/audit_panel_alignment.py path/to/figure.alignment-layout.json \
...
python perfect-figures/scripts/audit_figure_collisions.py path/to/figure.pdf \
...
python perfect-figures/scripts/audit_figure_collisions.py path/to/figure.pdf --strict
```
...
```bash
python -m pip install -r perfect-figures/requirements.txt
```
