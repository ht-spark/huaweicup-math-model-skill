...
VALIDATOR = load_module("perfect_figures_validator_test", SKILL / "scripts" / "validate_figure.py")
PDF_AUDIT = load_module("perfect_figures_pdf_audit_test", SKILL / "scripts" / "audit_pdf_text.py")
FIGURE_SAFETY = load_module("perfect_figures_safety_test", SKILL / "scripts" / "figure_safety.py")
