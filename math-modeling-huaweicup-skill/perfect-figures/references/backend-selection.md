...
3. saved preference from `scripts/perfect_figures_backend.py get`;
...
`scripts/perfect_figures_backend.py set python` or `scripts/perfect_figures_backend.py set r`.
